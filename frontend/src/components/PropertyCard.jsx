    ...
    return (
        <Link to={
          ...
          />
                    ...
                    {
                    property.is_available && !property.is_under_validation ? (
                        ...
                        <div className="absolute top-3 right-3">
                            <span className="text-[10px] uppercase tracking-wider font-bold bg-amber-500 text-white px-3 py-1 rounded-full shadow-sm">
